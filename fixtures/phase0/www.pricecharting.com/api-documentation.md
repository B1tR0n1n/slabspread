...
# PriceCharting API Documentation
 ...
 Documentation for all PriceCharting APIs, including the Prices API to get current item prices and the Marketplace API to automate all aspects of finding and selling items on the Marketplace.
...
## API Limits
 ...
 The API is limited to 1 call every second. Any more than that and your calls will be blocked and your account permissions revoked if it persists. You should use the API calls responsibly and not make more calls than you need.

 CSV calls are limited to one every 10 minutes. If you need lots of data on multiple items, it is best practice to download a CSV so you can get thousands of items in one request.

## Usage & Attribution

 The API and CSV data are licensed for internal use only. Sharing our price data with a third party, or making it available within an application or service used by others, requires a commercial license and express written permission from us. Contact us if you'd like to discuss a commercial license.

 If you have approval to share our price data in your application via a Commercial Agreement, we'd prefer attribution of either a logo or text linkback to our specific product page.

 https://www.pricecharting.com/game/{{PriceCharting_ID_Goes_Here}}

 Data can and should be cached/stored on your servers. Instead of making requests to the API for all of your user requests, you should store the API/CSV results in your database and serve those requests to your users.
...
# Download Data via CSV File
 ...
 CSV price columns are in USD with two decimal places.
...
# Prices API
 ...
 The API and CSV only support current item values in various grades and conditions.
...
Comics: Graded 4.0 or 4.5 by a grading company
  ...
  |  condition-10-price   |  Cards: Graded 2 by a grading company
Comics: Graded 9.6 (Near Mint +) by a grading company

  |  condition-13-price   |  Cards: Graded 3 by a grading company
Comics: Graded 3.0 by a grading company

  |  condition-14-price   |  Cards: Graded 4 by a grading company
Comics: Graded 5.0 by a grading company

  |  condition-15-price   |  Cards: Graded 5 by a grading company
Comics: Graded 7.0 by a grading company

  |  condition-16-price   |  Cards: Graded 6 by a grading company
Comics: Graded 9.0 by a grading company
...
Comics: Graded 9.4 by a grading company
  ...
  |  condition-19-price   |  Cards: CGC 10 Pristine

  |  condition-20-price   |  Cards: BGS 10 Black

  |  condition-21-price   |  Cards: TAG 10

  |  condition-22-price   |  Cards: ACE 10

  |  condition-9-price   |  Cards: Graded 1 by a grading company
Comics: Graded 2.0 (Good) by a grading company
...
Comics: Graded 6.0 or 6.5 by a grading company
  ...
  |  tcg-id   |  Unique identifier for this product on TCGplayer.com. Only available for trading cards (Magic, Pokemon, Yu-Gi-Oh, etc.).
...
## Console ID Table
  ...
  |  RCA Studio II   |  G87937

  |  RDI Halcyon   |  G91000

  |  Retro Gamer Magazine   |  G93657
...
- Return Policy
 ...
 PriceIt Game | No More Secrets Puzzle Game
