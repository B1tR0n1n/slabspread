---
url: https://api.psacard.com/publicapi/swagger.json
...

{
      ...
      "get": {
        ...
        "responses": {
          "200": {
            "description": "OK",
            "schema": {
              "$ref": "#/definitions/PublicCertificationModel"
            }
          }
        }
      }
      ...
      "get": {
        ...
        "responses": {
          "200": {
            "description": "OK",
            "schema": {
              "$ref": "#/definitions/CertFileAppendModel"
            }
          }
        }
      }
      ...
      "get": {
        ...
        "responses": {
          "200": {
            "description": "OK",
            "schema": {
              "$ref": "#/definitions/PSASpecPopulationModel"
            }
          }
        }
      }
  ...
  "definitions": {
    "PublicCertificationModel": {
      ...
      "properties": {
        "PSACert": {
          "$ref": "#/definitions/PublicPSACert"
        },
        "DNACert": {
          "$ref": "#/definitions/PublicDNACert"
        }
      }
    },
    "PublicPSACert": {
    ...
    "CertFileAppendModel": {
      ...
      "properties": {
        ...
        "PSACert": {
          "$ref": "#/definitions/CertFileAppendPSACert"
        },
        "PSAPopulation": {
          "$ref": "#/definitions/CertFileAppendPSAPopulation"
        },
        "DNACert": {
          "$ref": "#/definitions/CertFileAppendDNACert"
        }
      }
    },
    ...
    "OrderProgress": {
      ...
      "properties": {
        ...
        "orderProgressSteps": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/OrderProgressStep"
          }
        }
      }
    },
    ...
    "PSASpecPopulationModel": {
      ...
      "properties": {
        ...
        "PSAPop": {
          "$ref": "#/definitions/PSASpecPopSummmaryModel"
        },
        "PSADNAPop": {
          "$ref": "#/definitions/PSASpecPopSummmaryModel"
        }
